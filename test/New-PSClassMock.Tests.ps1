...
Describe "New-PSClassMock" {
    ...
    It 'Method Setup - Given nonexistent method, should throw' {
        $className = [Guid]::NewGuid().ToString()
        $testClass = New-PSClass $className {
            method 'foo' {}
        } -PassThru
        ...
        { $mock.Setup('bar') } | Should Throw 'Member with name: ''bar'' does not exist on this class/mock.'
    }
    ...
    It 'Method Verify - Given nonexistent method, should throw' {
        $className = [Guid]::NewGuid().ToString()
        $testClass = New-PSClass $className {
            method 'foo' {}
        } -PassThru
        ...
        { $mock.Verify('bar') } | Should Throw 'Member with name: ''bar'' does not exist on this class/mock.'
    }
    ...
    It 'Property Setup - Given nonexistent property, should throw' {
        $className = [Guid]::NewGuid().ToString()
        $testClass = New-PSClass $className {
            property 'foo' {}
        } -PassThru
        ...
        { $mock.SetupProperty('bar') } | Should Throw 'Member with name: ''bar'' does not exist on this class/mock.'
    }
    ...
    It 'Property Get Verify - Given nonexistent property, should throw' {
        $className = [Guid]::NewGuid().ToString()
        $testClass = New-PSClass $className {
            property 'foo' {}
        } -PassThru
        ...
        { $mock.VerifyGet('bar') } | Should Throw 'Member with name: ''bar'' does not exist on this class/mock.'
    }
    ...
    It 'Property Set Verify - Given nonexistent property, should throw' {
        $className = [Guid]::NewGuid().ToString()
        $testClass = New-PSClass $className {
            property 'foo' {}
        } -PassThru
        ...
        { $mock.VerifySet('bar') } | Should Throw 'Member with name: ''bar'' does not exist on this class/mock.'
    }
